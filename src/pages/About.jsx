  ...
  return (
    ...
    <div className="text-gray-900">
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-10 items-center border-2 border-pink-300 rounded-xl p-6">
          <div>
      ...
      {/* Story Section */}
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <div className="border-2 border-red-300 rounded-xl p-6">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-3 text-red-600">Our Story</h2>
              <p className="text-base leading-relaxed text-gray-800">
                Founded in 2023 by a group of passionate creators, PrintCraft was born from the desire to bring personalized apparel to everyone. Starting as a small idea in a college dorm, we've grown into a vibrant team with a shared love for creativity and technology.
              </p>
              ...
              <p className="text-base leading-relaxed text-gray-800 mt-4">
                Today, our platform supports both small startups and major enterprises in bringing their visions to life on fabric, from t-shirts to tote bags. Our story is just getting started.
              </p>
            </div>
            <img
